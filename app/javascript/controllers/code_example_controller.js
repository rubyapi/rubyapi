...
export default class extends Controller {
  ...
  connect() {
    ...
    codeBar.innerHTML = "<h4 class=\"text-gray-300 text-sm\">ruby</h4><button tilte=\"Copy to clipboard\" data-action=\"click->code-example#copy\"><span data-target=\"code-example.copy\" class=\"text-gray-300 fill-current hover:text-gray-500\"><i class=\"far fa-copy\"></i></span></button>"
