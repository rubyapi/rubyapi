  ...
  task generate: :environment do
    ...
    SitemapGenerator::Sitemap.create do
      ...
      Rails.configuration.ruby_versions.each do |version|
        ...
        group(filename: "ruby_#{version}", sitemaps_path: "sitemaps/") do
          response.results.each do |o|
            priority = Ruby::CORE_CLASSES.include?(o.constant) ? 0.5 : 0.9
            add Rails.application.routes.url_helpers.object_path(version: version, object: o.path), changefreq: "monthly", priority: priority
          end
        end
      end
    end
